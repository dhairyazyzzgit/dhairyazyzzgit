...
Computer Science student passionate about building polished, real-world software while strengthening my foundations in Data Structures & Algorithms and software engineering.

I enjoy taking ideas from concept to deployment by focusing on clean architecture, intuitive user experiences, and scalable engineering practices.
...
- Premium cyberpunk-inspired interface with cinematic animations
- Built for entertainment, curiosity, and social sharing
...
A website security intelligence platform that combines multiple threat intelligence sources to help identify suspicious or malicious websites.

- Google Safe Browsing integration
- URLScan analysis
- Heuristic risk scoring
- Domain age & URL inspection
- Clear security verdict system
...
A modern e-commerce application designed around a clean shopping experience with practical features found in real online stores.
...
A healthcare appointment management platform inspired by real-world patient booking workflows.
...
- Building polished, production-ready software

---

# 🔌 Beyond Code

Technology interests that extend beyond software.

- ⚡ Electronics & hardware
- 🛠️ Building real-world projects
- 🎥 Sharing project showcases on YouTube
...
### **Strong fundamentals. Clean systems. Real products.**
